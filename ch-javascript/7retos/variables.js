...
//The code uses `==` for value comparison (loose equality) where the values are the same but types differ, and `===` for strict equality where both value and type must match